...
from stacked_lstm_model.params import Params
...
class ClassificationModel(object):
    ...
    def __init__(self,
        ...
        stacked_lstm_layer = self.get_stacked_lstm()(embed_layer)
        # print(stacked_lstm_layer.shape)

        dense_layer = Dense(dense_size,
                            activation="relu",
                            trainable=True)(stacked_lstm_layer)
