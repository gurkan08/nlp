...
from stacked_rnn_model.params import Params
...
class ClassificationModel(object):
    ...
    def __init__(self,
        ...
        stacked_rnn_layer = self.get_stacked_rnn()(embed_layer)
        # print(stacked_rnn_layer.shape)

        dense_layer = Dense(dense_size,
                            activation="relu",
                            trainable=True)(stacked_rnn_layer)
