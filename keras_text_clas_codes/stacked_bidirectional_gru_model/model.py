...
from stacked_bidirectional_gru_model.params import Params
...
class ClassificationModel(object):
    ...
    def __init__(self,
        ...
        stacked_bidirectional_gru_layer = self.get_stacked_bidirectional_gru()(embed_layer)
        # print(stacked_bidirectional_gru_layer.shape)

        dense_layer = Dense(dense_size,
                            activation="relu",
                            trainable=True)(stacked_bidirectional_gru_layer)
    ...
    def get_stacked_bidirectional_gru(self):
        model = Sequential()
        # first layer
        model.add(Bidirectional(GRU(Params.gru_units,
