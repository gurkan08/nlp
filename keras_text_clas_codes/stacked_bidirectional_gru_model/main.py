...
from stacked_bidirectional_gru_model.preprocess import *
from stacked_bidirectional_gru_model.model import ClassificationModel
...
if __name__ == '__main__':
    ...
    data = Main.read_dataset(Params.excel_dir)
