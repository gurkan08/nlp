...
def load_model(model_hidden_size):
    config = AutoConfig.from_pretrained("model/", dim=model_hidden_size)
...
class Params(object):
    ...
    model_name = "dbmdz/distilbert_model-base-turkish-cased"
    download_or_load_model = "load" # download | load
    tokenizer = None
    model = None # distilbert_model model
    ...
    pipeline_model = None # distilbert_model + fc nn
    optimizer = None
    criterion = None
