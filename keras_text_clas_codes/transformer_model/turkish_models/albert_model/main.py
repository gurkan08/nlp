...
from transformer_model.turkish_models.albert_model.preprocess import *
from transformer_model.turkish_models.albert_model.mydataloader import MyDataloader
from transformer_model.turkish_models.albert_model.mymodel import MyModel
from transformer_model.turkish_models.albert_model.params import Params
...
class Main(object):
    ...
    def run_train(dataloader):
        ...
        for id, (X, y) in enumerate(dataloader):  # batch
            ...
            outputs = Params.pipeline_model(input_ids, token_type_ids, attention_mask) # bert
            #print(outputs)
